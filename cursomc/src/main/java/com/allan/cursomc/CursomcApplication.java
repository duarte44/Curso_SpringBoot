...
public class CursomcApplication implements CommandLineRunner{
	...
	@Autowired
	private PedidoRepository pediodoRepository;
	@Autowired
	...
	public void run(String... args) throws Exception {
		...
		Endereco e2 = new Endereco (null, "Avenida matos", "105", "Sala 800", "Centro", "36363636",cli1, c2);
		...
		pediodoRepository.saveAll(Arrays.asList(ped1,ped2));
